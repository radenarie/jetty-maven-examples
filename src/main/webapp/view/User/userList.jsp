...
<div class="row float-right">
    <div class="col-md-4">
        <button class="btn btn-primary" onclick="window.location.href='view/tambahData';">Tambah Data</button>
    </div>
</div>
<br>
    ...
    <c:forEach var="user" items="${Users}">
        <tr>
            ...
            <td>
                <div class="row">
                    <div class="col-sm-2">
                        <a href="view/update?id=<c:out value='${user.id}'/>" class="btn btn-warning"><i
                                class="fa fa-pencil"></i></a>
                    </div>
                    <div class="col-sm-2">
                        <a href="#" class="delete-modal btn btn-danger" data-value="<c:out value='${user.id}' />"
                           data-toggle="modal"
