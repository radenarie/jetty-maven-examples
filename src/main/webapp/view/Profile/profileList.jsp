...
<div class="row float-right">
    <div class="col-md-4">
        <button class="btn btn-primary" onclick="window.location.href='pview/tambahData';">Tambah Data</button>
    </div>
</div>
<br>
<c:if test="${param.upsuc == 0}">
...
<table class="table table-striped">
    ...
    <tbody>
    <c:forEach var="data" items="${Profile}">
        <tr>
            <td><c:out value="${data.id}"/></td>
            <td><c:out value="${data.namaLengkap}"/></td>
            <td><c:out value="${data.alamat}"/></td>
            <td><c:out value="${data.umur}"/></td>
            <td><c:out value="${data.jenisKelamin}"/></td>
            <td>
                <div class="row">
                    <div class="col-sm-2">
                        <a href="pview/update?id=<c:out value='${data.id}'/>" class="btn btn-warning"><i
    ...
    <div class="modal-dialog modal-confirm">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="pview/delete" method="post">
